...
{
    public class ChatMessageTypeToBackgroundColorConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            if (value is ChatMessageType chatMessageType)
            {
                string resourceName = chatMessageType == ChatMessageType.Sent ? "AcrylicBackgroundFillColorDefaultInverseBrush" : "AccentAcrylicBackgroundFillColorDefaultBrush";
